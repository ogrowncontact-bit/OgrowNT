...
/** Magic-link report access — same double opt-in shape as privacyConfirm.ts: the link only lands on a confirm page, it never grants access by itself. */
export function renderAccessLinkEmail(params: AccessLinkParams): string {
  return `<!doctype html>
<html>
            ...
            <tr>
              <td style="padding:32px 28px 8px;">
                ...
                <p style="margin:0 0 20px;font-size:15px;line-height:1.6;color:#4a453d;">
                  Click below to view every INNER report you've purchased, from any device.
                </p>
            ...
            <tr>
              <td style="padding:20px 28px 28px;border-top:1px solid #e6dcc8;">
                <p style="margin:0;font-size:12px;line-height:1.6;color:#78705f;">
                  ...
                  before access is granted. Didn't request this? You can safely ignore this email.
                </p>
              </td>
            </tr>
          </table>
