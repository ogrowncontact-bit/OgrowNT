...
/** Transactional — about finishing a purchase the recipient already started, not marketing. See docs/ARCHITECTURE.md §11. */
export function renderCheckoutReminderEmail(params: CheckoutReminderParams): string {
  return `<!doctype html>
<html>
            ...
            <tr>
              <td style="padding:32px 28px 8px;">
                ...
                <h1 style="margin:0 0 16px;font-family:Georgia,'Iowan Old Style','Palatino Linotype',ui-serif,serif;font-size:24px;line-height:1.3;color:#1c1a17;">
                  ${escapeHtml(params.assessmentName)} — your profile is ready to unlock
                </h1>
                <p style="margin:0 0 20px;font-size:15px;line-height:1.6;color:#4a453d;">
                  You finished the questions but didn't complete checkout. Your full report — ${escapeHtml(params.priceLabel)} —
                  is still waiting whenever you'd like it.
                </p>
            ...
            <tr>
              <td style="padding:20px 28px 28px;border-top:1px solid #e6dcc8;">
                <p style="margin:0;font-size:12px;line-height:1.6;color:#78705f;">
                  You're getting this because you started checkout for this report. It's a one-time reminder about this
                  specific purchase, not a recurring email.
                </p>
              </td>
            </tr>
          </table>
