...
export default function ServicesPage() {
  ...
  return (
    <div className="flex h-screen flex-col">
      <AppHeader active="services" businessId={businessId} memberships={memberships} onBusinessChange={setBusinessId} />
      {businessId && <ServicesView key={businessId} businessId={businessId} token={token} />}
    </div>
  );
}
