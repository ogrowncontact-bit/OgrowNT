...
export default function ProfilePage() {
  ...
  return (
    <div className="flex h-screen flex-col">
      <AppHeader active="profile" businessId={businessId} memberships={memberships} onBusinessChange={setBusinessId} />
      {businessId && <ProfileView key={businessId} businessId={businessId} token={token} />}
    </div>
  );
}
