...
export default function AutomationsPage() {
  ...
  return (
    <div className="flex h-screen flex-col">
      <AppHeader active="automations" businessId={businessId} memberships={memberships} onBusinessChange={setBusinessId} />
      {businessId && <AutomationsView key={businessId} businessId={businessId} token={token} />}
    </div>
  );
}
